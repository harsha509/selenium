...
type PartitionType = typeof Type[keyof typeof Type];
...
class PartitionDescriptor {
   ...
   */
  constructor(type: PartitionType) {
    this.#type = type;
  }
}
...
class StorageKeyPartitionDescriptor extends PartitionDescriptor {
   ...
   * @returns {StorageKeyPartitionDescriptor} - The updated partition descriptor instance for chaining.
   */
  userContext(userContext: any): StorageKeyPartitionDescriptor {
   ...
   * @returns {StorageKeyPartitionDescriptor} - The updated PartitionDescriptor instance for chaining.
   */
  sourceOrigin(sourceOrigin: string): StorageKeyPartitionDescriptor {
...
export { BrowsingContextPartitionDescriptor, StorageKeyPartitionDescriptor };
