...
export class BrowsingContextInfo {
  ...
  private _parentBrowsingContext: BrowsingContextInfo;

  constructor(id: string, url: string, children: BrowsingContextInfo[], parentBrowsingContext: BrowsingContextInfo) {
    this._id = id;
    this._url = url;
   ...
   */
  get children(): Array<BrowsingContextInfo> {
   ...
   */
  get parentBrowsingContext(): BrowsingContextInfo {
...
export class NavigationInfo {
   ...
   */
  constructor(
    public browsingContextId: string,
...
export class UserPromptClosed {
  ...
  public userText: string | undefined = undefined
) {}
}
