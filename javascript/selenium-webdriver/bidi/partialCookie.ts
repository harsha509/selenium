...
import { BytesValue } from './networkTypes';
...
class PartialCookie {
   ...
   */
  path(path: string): PartialCookie {
   ...
   * @returns {PartialCookie} - The updated PartialCookie instance for chaining.
   */
  size(size: number): PartialCookie {
   ...
   * @returns {PartialCookie} - The updated PartialCookie instance for chaining.
   */
  httpOnly(httpOnly: boolean): PartialCookie {
   ...
   * @returns {PartialCookie} - The updated PartialCookie instance for chaining.
   */
  secure(secure: boolean): PartialCookie {
   ...
   *
   * @param {string} sameSite - The SameSite attribute value for the cookie.
   * @returns {PartialCookie} - The updated PartialCookie instance for chaining.
   */
  sameSite(sameSite: string): PartialCookie {
   ...
   * @returns {PartialCookie} - The updated PartialCookie instance for chaining.
   */
  expiry(expiry: number): PartialCookie {
