...
class BrowsingContextInspector {
  ...
  constructor(driver: any, browsingContextIds: string[] | null) {
    this._driver = driver;
   ...
   */
  async onBrowsingContextCreated(callback: (info: BrowsingContextInfo) => void): Promise<void> {
   ...
   * @returns {Promise<void>} - A promise that resolves when the event is emitted.
   */
  async onBrowsingContextDestroyed(callback: (info: BrowsingContextInfo) => void): Promise<void> {
   ...
   * @returns {Promise<void>} - A promise that resolves when the event is emitted.
   */
  async onNavigationStarted(callback: (info: NavigationInfo) => void): Promise<void> {
   ...
   * @returns {Promise<void>} - A promise that resolves when the event is emitted.
   */
  async onFragmentNavigated(callback: (info: NavigationInfo) => void): Promise<void> {
   ...
   * @returns {Promise<void>} - A promise that resolves when the event is emitted.
   */
  async onUserPromptClosed(callback: (info: UserPromptClosed) => void): Promise<void> {
   ...
   * @returns {Promise<void>} - A promise that resolves when the event is emitted.
   */
  async onUserPromptOpened(callback: (info: UserPromptOpened) => void): Promise<void> {
   ...
   * @returns {Promise<void>} - A promise that resolves when the event is emitted.
   */
  async onDomContentLoaded(callback: (info: NavigationInfo) => void): Promise<void> {
   ...
   * @returns {Promise<void>} - A promise that resolves when the event is emitted.
   */
  async onBrowsingContextLoaded(callback: (info: NavigationInfo) => void): Promise<void> {
    await this.subscribeAndHandleEvent('browsingContext.load', callback);
  }

  async subscribeAndHandleEvent(eventType: string, callback: Function): Promise<void> {
...
export async function getBrowsingContextInstance(driver: any, browsingContextIds: string[] | null = null): Promise<BrowsingContextInspector> {
