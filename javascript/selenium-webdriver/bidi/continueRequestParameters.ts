...
class ContinueRequestParameters {
   ...
   */
  body(value: BytesValue): ContinueRequestParameters {
   ...
   */
  cookies(cookieHeaders: Header[]): ContinueRequestParameters {
    const cookies = []
   ...
   */
  headers(headers: Header[]): ContinueRequestParameters {
    const headerList = []
   ...
   */
  method(method: string): ContinueRequestParameters {
   ...
   */
  url(url: string): ContinueRequestParameters {
...
export { ContinueRequestParameters }
