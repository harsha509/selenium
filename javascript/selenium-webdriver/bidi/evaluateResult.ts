...
// Type for EvaluateResultType values
type EvaluateResultTypeValues = typeof EvaluateResultType[keyof typeof EvaluateResultType];
...
class EvaluateResultSuccess {
  resultType: EvaluateResultTypeValues;
  realmId: string;
  result: any;

  constructor(realmId: string, value: any) {
...
class ExceptionDetails {
  ...
  constructor(exceptionDetails: Record<string, any>) {
