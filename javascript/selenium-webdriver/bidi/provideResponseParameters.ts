...
class ProvideResponseParameters {
   ...
   */
  body(value: BytesValue): ProvideResponseParameters {
   ...
   */
  cookies(cookieHeaders: Header[]): ProvideResponseParameters {
    const cookies = []
   ...
   */
  headers(headers: Header[]): ProvideResponseParameters {
    const headerList = []
   ...
   */
  reasonPhrase(reasonPhrase: string): ProvideResponseParameters {
   ...
   */
  statusCode(statusCode: number): ProvideResponseParameters {
...
export { ProvideResponseParameters };
