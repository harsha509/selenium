...
export class AddInterceptParameters {
   ...
   */
  urlPattern(pattern: UrlPattern): AddInterceptParameters {
   ...
   * @throws {Error} - Throws an error if the pattern is not an instance of UrlPattern.
   */
  urlPatterns(patterns: UrlPattern[]): AddInterceptParameters {
   ...
   */
  urlStringPattern(pattern: string): AddInterceptParameters {
   ...
   */
  urlStringPatterns(patterns: string[]): AddInterceptParameters {
    patterns.forEach((pattern) => {
      if (typeof pattern !== 'string') {
        throw new Error(`Pattern must be an instance of String. Received:'${pattern}'`);
      }
