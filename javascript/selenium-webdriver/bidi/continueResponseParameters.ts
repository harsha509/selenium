...
class ContinueResponseParameters {
   ...
   */
  cookies(cookieHeaders: Header[]): ContinueResponseParameters {
    const cookies = []
   ...
   */
  credentials(username: string, password: string): ContinueResponseParameters {
   ...
   */
  headers(headers: Header[]): ContinueResponseParameters {
    const headerList = []
   ...
   */
  reasonPhrase(reasonPhrase: string): ContinueResponseParameters {
   ...
   */
  statusCode(statusCode: number): ContinueResponseParameters {
...
export { ContinueResponseParameters }
