...
class FetchTimingInfo {
  ...
  private _redirectStart: number;
  private _redirectEnd: number;
  private _fetchStart: number;
  private _dnsStart: number;
  private _dnsEnd: number;
  private _connectStart: number;
  private _connectEnd: number;
  private _tlsStart: number;
  private _requestStart: number;
  private _responseStart: number;
  private _responseEnd: number;
...
class BaseParameters {
  ...
  protected _navigation: NavigationInfo | null;
...
class FetchError extends BaseParameters {
   ...
   */
  constructor(id: string, navigation: any, redirectCount: number, request: RequestDataParams, timestamp: number, errorText: string) {
    super(id, navigation, redirectCount, request, timestamp)
...
class ResponseStarted extends BaseParameters {
  private _response: ResponseData;

  constructor(id: string, navigation: any, redirectCount: number, request: RequestDataParams, timestamp: number, response: ResponseDataParams) {
    super(id, navigation, redirectCount, request, timestamp)
...
export { Header, BytesValue, Cookie, SameSite, BeforeRequestSent, ResponseStarted, FetchError };
