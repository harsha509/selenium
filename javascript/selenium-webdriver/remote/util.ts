...
/**
 * Determines if the Selenium server is version 3.x
 * @param seleniumStandalonePath path to standalone server
 * @returns Whether the server is version 3.x
 */
...
/**
 * Formats spawn arguments based on Selenium standalone server version
 * @param seleniumStandalonePath path to standalone server
